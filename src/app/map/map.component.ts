...
@Component({
  selector: 'app-map',
  standalone: true,
  imports: [NgxEchartsDirective, PieChartComponent, LineZapishaniZavrsheniComponent, StackedBarZapishaniZavrsheniComponent, OsnovnoModalComponent, PieZavrsheniZapishaniComponent],
